...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260921091347_HRM_AddRecruitmentPipeline")]
    partial class HRM_AddRecruitmentPipeline
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ApplicationEvaluation", b =>
                {
                    ...
                    b.Property<Guid?>("InterviewScheduleId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InterviewScheduleId1");
            ...
            modelBuilder.Entity("Domain.RecruitmentPipeline", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RecruitmentPipelines");
                });

            modelBuilder.Entity("Domain.RecruitmentPipelineStage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.RoundType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.ApplicationEvaluation", b =>
                {
                    ...
                    b.HasOne("Domain.InterviewSchedule", null)
                        .WithMany("Evaluations")
                        .HasForeignKey("InterviewScheduleId1");
            ...
            modelBuilder.Entity("Domain.InterviewRuleConfigStep", b =>
                {
                    ...
                    b.HasOne("Domain.RoundType", "RoundType")
                        .WithMany("Steps")
            ...
            modelBuilder.Entity("Domain.RecruitmentPipelineStage", b =>
                {
                    b.HasOne("Domain.RecruitmentPipeline", "Pipeline")
                        .WithMany("Stages")
