...
public static class PermissionNames
{
    public static readonly Dictionary<string, (string Name, string Description)> Map = new()
    {
        ...
        ["hrm:recruitment:request:approve-level1"] = ("Duyệt phiếu tuyển dụng cấp 1", "Giám sát vùng / Trưởng bộ phận duyệt phiếu đề xuất tuyển dụng cấp 1"),
        ["hrm:recruitment:request:approve"]        = ("Duyệt phiếu tuyển dụng cấp 2", "Trưởng phòng Nhân sự phê duyệt cuối phiếu đề xuất tuyển dụng"),
