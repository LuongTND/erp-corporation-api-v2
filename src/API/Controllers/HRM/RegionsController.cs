...
{
    [HasPermission(RegionPermissions.ViewList)]
    [HttpGet]
    ...
    [HasPermission(RegionPermissions.Sync)]
    [HttpPost("sync")]
    ...
    [HasPermission(RegionPermissions.ViewHours)]
    ...
    [HasPermission(RegionPermissions.UpdateHours)]
